<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xw_Add.aspx.cs" Inherits="System_Sys_Member_Add" %>
...
<body onload="sel()">
    <form id="form1" runat="server">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#b5d6e6" class="grid" style="height:250px;">
                        <tr>
