<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sys_Manager_List.aspx.cs"
    Inherits="System_Sys_Manager_List" %>
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="97%">
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[<a href="sys_manager_add.aspx">添加管理员</a>]</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td width="10%"></td>
                                        ...
                                        <td>
                                            <asp:GridView ID="GridView1" runat="server" CssClass="grid" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Manager_Name" HeaderText="用户名" />
                                                    <asp:TemplateField HeaderText="操作">
                                                        <ItemTemplate>
                                                            <img src="images/edt.gif" width="16" height="16" /><asp:LinkButton ID="LinkButton2"
                                                                runat="server" CommandArgument='<%# Eval("Manager_ID") %>' CommandName="reset">重置密码</asp:LinkButton>&nbsp;&nbsp;&nbsp;
                                                            <img src="images/del.gif" width="16" height="16" /><asp:LinkButton ID="LinkButton1"
                                                                runat="server" CommandArgument='<%# Eval("Manager_ID") %>' CommandName="del"
