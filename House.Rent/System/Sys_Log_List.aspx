<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sys_Log_List.aspx.cs"
    Inherits="System_Sys_Log_List" %>
                                        ...
                                        <td width="46%" valign="middle">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="95%">
                                                        <b>你当前的位置</b>：
                                                        [<a href="sys_log_list.aspx">租房记录</a>]
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                    ...
                                    <tr bgcolor="#ffffff">
                                        <td height="32" colspan="2" style="padding: 10px;">&nbsp;
                                            <asp:GridView ID="GridView1" runat="server" CssClass="grid" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    <asp:BoundField DataField="l_id" HeaderText="编号">
                                                        <ItemStyle HorizontalAlign="Center" Width="60px" />
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                                                    <asp:TemplateField HeaderText="标题">
                                                        <ItemTemplate>
                                                            <a href="../supply-display.aspx?id=<%#Eval("pro_id") %>" target="_blank"><%#Eval("pro_title")%></a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="名称">
                                                        <ItemTemplate>
                                                            <a href="../supply-display.aspx?id=<%#Eval("pro_id") %>" target="_blank"><%#Eval("pro_name")%></a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
