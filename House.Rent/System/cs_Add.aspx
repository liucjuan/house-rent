<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cs_Add.aspx.cs" Inherits="System_Sys_Member_Add" %>
                                        ...
                                        <td width="90%" valign="middle">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="97%">
                                                        <b>你当前的位置</b>：[<a href="csht_List.aspx">出售合同管理</a>] - [<a href="sys_member_add.aspx">添加出售合同</a>]</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td width="10%">
