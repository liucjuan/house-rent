<%@ Page Language="C#" AutoEventWireup="true" CodeFile="czht_List.aspx.cs"
                                        ...
                                        <td width="46%" valign="middle">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    ...
                                                    <td width="95%">
                                                        <b>你当前的位置</b>：[<a href="csht_list.aspx">出租合同</a>][<a href="cs_Add.aspx">添加出租合同</a>]</td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td width="54%">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" CssClass="grid" AutoGenerateColumns="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="标题">
                                                        <ItemTemplate>
                                                            <a href="cs_Add.aspx?id=<%#Eval("id") %>" target="frmright"><%#Eval("title") %></a>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                   
                                                   
                                                    <asp:TemplateField HeaderText="下载合同">
                                                        <ItemTemplate>
                                                   <a href="<%#"../upload/"+Eval("path")%>">下载合同</a>         
