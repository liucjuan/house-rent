                    ...
                    <asp:Repeater ID="rep_intro" runat="server" OnItemDataBound="rep_intro_ItemDataBound" OnItemCommand="rep_intro_ItemCommand">
                        <ItemTemplate>
                            <div class="col-cont title-box" style="z-index: 34;">
                                <h1 class="title-name">【魔方公寓】布局合理，配套齐全，咫尺之间，尽享生活品味和品质</h1>
                                <div class="title-info clearfix">
                                    <ul class="title-info-l clearfix">
                                        <li><i class="f10 pr-5">2016-04-02</i>发布</li>
                                        <li>浏览<i id="pageviews" class="f10 pl-5" data-widget="app/ms_v2/housing/detail.js#getPageView" data-text-format=" %s "></i>次</li>
                                    </ul>
                                </div>
                            </div>
